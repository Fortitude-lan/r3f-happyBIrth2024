...
Command: npx gltfjsx@6.2.15 public/models/Charizard_anims.glb -o src/components/CharizarGLB.jsx 
* 火焰效果小火龙
*GLb模型渲染 
*尾巴着色片段设置颜色 
*尾巴scale useFrams控制
...
export function Charizard({ hovered, ...props }) {
  ...
  useFrame((state, delta) => {
    // 上下浮动
    const time = state.clock.elapsedTime; // 获取经过的总时间
    const offsetY = Math.sin(time) * 3 + 10;
...
useGLTF.preload("/models/Charizard_anims.glb");
